...
public class ReservaMockTest {
    ...
    void setUp() {
        ...
        rmock = EasyMock.partialMockBuilder(Reserva.class).addMockedMethods("setFd", "compruebaPermisos").createMock(ctl);
        fbomock = ctl.createMock(FactoriaBOs.class);
        iobomock = ctl.createMock(IOperacionBO.class);
    ...
    void realizaReserva_C1() {
        ...
        EasyMock.expect(rmock.compruebaPermisos(login,password,Usuario.BIBLIOTECARIO)).andReturn(false);
        ctl.replay();
    ...
    void realizaReserva_C2() {
        ...
        EasyMock.expect(fbomock.getOperacionBO()).andReturn(iobomock);
        Assertions.assertDoesNotThrow(() -> {
            iobomock.operacionReserva(socio,isbns[0]);
            EasyMock.expectLastCall();
            iobomock.operacionReserva(socio,isbns[1]);
            EasyMock.expectLastCall();
        });
        ctl.replay();
